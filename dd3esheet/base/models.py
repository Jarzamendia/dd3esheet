...
class Character(models.Model):
    ...
    # CharacterStatus          = models.ForeignKey("CharacterStatus", on_delete=models.CASCADE)
    # CharacterSavingThrows    = models.ForeignKey("CharacterSavingThrows", on_delete=models.CASCADE)
    # CharacterAttackModifiers = models.ForeignKey("CharacterAttackModifiers", on_delete=models.CASCADE)
    # CharacterWeapon          = models.ForeignKey("CharacterWeapon", on_delete=models.CASCADE)
    # CharacterSkillGraduation = models.ForeignKey("CharacterSkillGraduation", on_delete=models.CASCADE)
    # CharacterSkill           = models.ForeignKey("CharacterSkill", on_delete=models.CASCADE)
    # CharacterArmor           = models.ForeignKey("CharacterArmor", on_delete=models.CASCADE)
    # CharacterShield          = models.ForeignKey("CharacterShield", on_delete=models.CASCADE)
    # CharacterProtectionItem  = models.ForeignKey("CharacterProtectionItem", on_delete=models.CASCADE)
    # CharacterOtherItem       = models.ForeignKey("CharacterOtherItem", on_delete=models.CASCADE)
    # CharacterOtherItemObs    = models.ForeignKey("CharacterOtherItemObs", on_delete=models.CASCADE)
    # CharacterMoney           = models.ForeignKey("CharacterMoney", on_delete=models.CASCADE)
    # CharacterFeat            = models.ForeignKey("CharacterFeat", on_delete=models.CASCADE)
    # CharacterAbility         = models.ForeignKey("CharacterAbility", on_delete=models.CASCADE)
...
#     Character = models.ForeignKey(Character, on_delete=models.CASCADE)
#     PlayerName = models.ForeignKey(User, on_delete=models.CASCADE)
#
