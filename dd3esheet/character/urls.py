...
urlpatterns = [
    ...
    path("character/<int:pk>/buffs/add/", views.add_buff, name="add-buff"),
    path("character/<int:pk>/buffs/<int:buff_id>/toggle/", views.toggle_buff, name="toggle-buff"),
    path("character/<int:pk>/buffs/<int:buff_id>/delete/", views.delete_buff, name="delete-buff"),
